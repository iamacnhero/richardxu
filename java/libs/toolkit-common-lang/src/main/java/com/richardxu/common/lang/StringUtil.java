...
public class StringUtil {
	...
	public static String fromCamelCasing(String str, char separator) {
		int strLen;
	 ...
	 */
	public static String toCamelCasing(String input,
			boolean firstCharUppercase, char separator) {
		if (input == null) {
			return null;
		}
	 ...
	 * 
	 * <pre>
	 * StringUtil.toPascalCasing(null)  = null
	 * StringUtil.toPascalCasing(&quot;&quot;)    = &quot;&quot;
	 * StringUtil.toPascalCasing(&quot;aBc&quot;) = &quot;ABc&quot;
	 * StringUtil.toPascalCasing(&quot;aBc def&quot;) = &quot;ABcDef&quot;
	 * StringUtil.toPascalCasing(&quot;aBc def_ghi&quot;) = &quot;ABcDefGhi&quot;
	 * StringUtil.toPascalCasing(&quot;aBc def_ghi 123&quot;) = &quot;aBcDefGhi123&quot;
	 * </pre>
	 * 
	 * </p>
	 * 
	 ...
	 */
	public static String toPascalCasing(String str) {
	...
	public static String[] splitc(String src, String d) {
		...
		start[0] = 0;
		int s = 0, e;
		if (CharUtil.equalsOne(srcc[0], delimiters)) { // string starts
														// with
														// delimiter
			end[0] = 0;
			count++;
	 ...
	 */
	public static int indexOf(String string, char[] chars, int startindex) {
		if (string == null || ArrayUtil.isEmpty(chars)) {
			return -1;
		}
	...
	public static int[] indexOfRegion(String string, String leftBoundary,
		...
		if (string == null || leftBoundary == null || rightBoundary == null) {
			return null;
		}
		int ndx = offset;
		int[] res = new int[4];
	...
	public static String[] toStringArray(String line) {
		if (line == null)
			return null;
		List<String> row = CollectionUtil.getArrayList();
		...
		for (int i = 0; i < len; i++) {
			...
			if (c == ',') {
				...
				if (inQuotedField) {
					if (i + 1 == len || line.charAt(i + 1) == ',') { // we are
																		// already
																		// quoting
																		// -
																		// peek
	...
	public static String findCommonPrefix(String... strings) {
		...
		return prefix.length() == 0 ? StringUtil.EMPTY_STRING : prefix
				.toString();
	}
	...
	public static String surround(String string, String prefix, String suffix) {
		if (string == null || suffix == null || prefix == null) {
			return string;
		}
	...
	public static String getJavaStyleMethodName(String name, String prefix) {
		...
		char[] results = new char[length + prefixLength];
		for (int i = 0; i < prefixLength; i++) {
			results[i] = prefix.charAt(i);
		}
		char c = name.charAt(0);
		if (c >= 'a' && c <= 'z')
			c += 'A' - 'a';
		results[prefixLength] = c;
		for (int i = 1; i < length; i++) {
			results[i + prefixLength] = name.charAt(i);
		}
