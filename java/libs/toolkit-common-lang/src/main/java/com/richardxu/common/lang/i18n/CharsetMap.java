 ...
 * @version create on 2011-5-18 下午02:42:13
 */
public class CharsetMap {
	...
	public CharsetMap() {
		...
		mappers[MAP_CACHE] = new Hashtable<Object, Object>();
	}
	 ...
	 * @throws IOException
	 */
	public CharsetMap(Properties props) throws IOException {
		this();
		mappers[MAP_PROG] = new HashMap<Object, Object>(props);
	}
	...
	public void setCharSet(String key, String charset) {
		...
		mapper = (mapper != null) ? (HashMap<String, String>) mapper.clone()
				: new HashMap();
	 ...
	 * @return the found charset or an empty string.
	 */
	private String searchCharSet(String[] items, StringBuilder base, int count) {
	...
	protected void setCommonCharSet(String key, String charset) {
		@SuppressWarnings("unchecked")
		Map<String, String> mapper = (Map<String, String>) ((HashMap<String, String>) mappers[MAP_COM])
				.clone();
