...
public class SystemUtil {
	...
	public static final class JvmSpecInfo {
		...
		public final String toString() {
			...
			append(builder, "JVM Spec. Name:    ", getName());
			append(builder, "JVM Spec. Version: ", getVersion());
			append(builder, "JVM Spec. Vendor:  ", getVendor());
	...
	public static final class JvmInfo {
		...
		public final String toString() {
			...
			append(builder, "JVM Name:    ", getName());
			append(builder, "JVM Version: ", getVersion());
			append(builder, "JVM Vendor:  ", getVendor());
			append(builder, "JVM Info:    ", getInfo());
