...
public class StringUtilTest {
	...
	public void testSplit() {
		...
		r = StringUtil.splitNoCompress(src, ",");
	...
	public void testReplace() {
		...
		src = "11221144";
		src = StringUtil.replaceOnce(src, "11", "55");
		assertEquals("55221144", src);
		src = StringUtil.replaceOnce(src, "11", "55");
		assertEquals("55225544", src);
		src = StringUtil.replaceOnce(src, "11", "55");
		assertEquals("55225544", src);
		String src2 = StringUtil.replaceOnce(src, '5', 'a');
	...
	public void testIndexOf() {
		...
		assertEquals(1, StringUtil.indexOfIgnoreCase(src, new String[] { "345",
				"234" })[0]);
		assertEquals(1, StringUtil.indexOfIgnoreCase(src, new String[] { "345",
				"234" })[1]);
		assertEquals(
				0,
				StringUtil.lastIndexOfIgnoreCase(src, new String[] { "345",
						"234" })[0]);
		assertEquals(
				2,
				StringUtil.lastIndexOfIgnoreCase(src, new String[] { "345",
		...
		assertEquals(0,
				StringUtil.lastIndexOfIgnoreCase(src, "1234567890QwErTy"));
	...
	public void testRemove() {
		...
		assertEquals("qeryq",
				StringUtil.removeChars(s, new char[] { 'w', 't' }));
	...
	public void testArrays() {
		...
		assertEquals("qWERtyuIOp", StringUtil.replace(s, new String[] { "wer",
				"io" }, new String[] { "WER", "IO" }));
		assertEquals("qwertyuiop", StringUtil.replace(s, new String[] { "wer1",
				"io1" }, new String[] { "WER", "IO" }));

		assertEquals("qWERtyuIOP", StringUtil.replace(s, new String[] { "wer",
				"iop" }, new String[] { "WER", "IOP" }));
		assertEquals("qWERtyuIOP", StringUtil.replaceIgnoreCase(s,
				new String[] { "WER", "IOP" }, new String[] { "WER", "IOP" }));

		assertEquals("qwertyuiop",
				StringUtil.replace(s, new String[] {}, new String[] {}));

		assertEquals("qWERtyuiop", StringUtil.replace(s, new String[] { "wer",
				"we" }, new String[] { "WER", "11" }));

		assertTrue(ArrayUtil.equals(new String[] { "wer", "io" }, new String[] {
				"wer", "io" }));
		assertFalse(ArrayUtil.equals(new String[] { "wer", "io" },
				new String[] { "WER", "IO" }));
		assertTrue(StringUtil.equalsIgnoreCase(new String[] { "wer", "io" },
				new String[] { "WER", "IO" }));

		assertEquals(1, StringUtil.indexOf(s, new String[] { "wer", "io" })[1]);
		assertEquals(7, StringUtil.indexOfIgnoreCase(s, new String[] { "wer",
				"IO" }, 2)[1]);
		assertEquals(7,
				StringUtil.lastIndexOf(s, new String[] { "wer", "io" })[1]);
		assertEquals(1, StringUtil.lastIndexOfIgnoreCase(s, new String[] {
				"WER", "io" }, 5)[1]);
	}
	...
	public void testRanges() {
		...
		assertEquals(-1,
				StringUtil.indexOfIgnoreCase(s, "iOp", 0, s.length() - 1));
		...
		assertEquals(6,
				StringUtil.lastIndexOfIgnoreCase(s, "iOp", s.length(), 0));
	...
	public void testTrim() {
		assertEquals("123", StringUtil.trim(" 123 "));
		assertEquals("123", StringUtil.trim("123"));
		...
		String s = " \t123\t ";
		assertEquals("123\t ", StringUtil.trimStart(s));
		assertEquals(" \t123", StringUtil.trimEnd(s));
	}
	...
	public void testReplaceChar() {
		...
		assertEquals("x234567890", StringUtil.replaceChars(s, '1', 'x'));
		assertEquals("x2yz567890", StringUtil.replaceChars(s, new char[] { '1',
				'3', '4' }, new char[] { 'x', 'y', 'z' }));
	}
	...
	public void testSurround() {
		...
		assertEquals("preqwesuf",
				StringUtil.surround("preqwesuf", "pre", "suf"));
	...
	public void testCuts() {
		...
		assertEquals("qwe",
				StringUtil.cutSurrounding("preqwesuf", "pre", "suf"));
	...
	public void testIndexOfChars() {
		...
		assertEquals(0, StringUtil.indexOfAny(s, "1q"));
		assertEquals(0, StringUtil.indexOfAny(s, "1q", 0));
		assertEquals(5, StringUtil.indexOfAny(s, "1q", 1));
		assertEquals(0, StringUtil.indexOfAny(s, "1q", -11));
		assertEquals(-1, StringUtil.indexOfAny(s, "1q", 200));
		assertEquals(1, StringUtil.indexOfAny(s, "q2"));
		assertEquals(5, StringUtil.indexOfAny(s, "yq"));
	}
	...
	public void testEquals() {
		...
		assertEquals(2, StringUtil.equalsOne("src", new String[] { "123", null,
				"src" }));
		assertEquals(-1, StringUtil.equalsOne("src", new String[] { "123",
				null, "Src" }));

		assertEquals(
				2,
				StringUtil.equalsOneIgnoreCase("sRc", new String[] { "123",
						null, "Src" }));
		assertEquals(
				-1,
				StringUtil.equalsOneIgnoreCase("sRc", new String[] { "123",
	...
	public void testStartWith() {
		...
		assertEquals(
				3,
				StringUtil.startsWithOne("qwe123", new String[] { "Qwe", null,
						".", "qwe" }));
		assertEquals(
				-1,
				StringUtil.startsWithOne("qwe123", new String[] { "Qwe", null,
		...
		assertEquals(
				0,
				StringUtil.startsWithOneIgnoreCase("qwe123", new String[] {
						"Qwe", null, ".", "qwe" }));
		assertEquals(
				-1,
				StringUtil.startsWithOneIgnoreCase("qwe123", new String[] {
		...
		assertEquals(
				3,
				StringUtil.endsWithOne("qwezxc", new String[] { "Zxc", null,
						".", "zxc" }));
		assertEquals(
				-1,
				StringUtil.endsWithOne("qwezxc", new String[] { "Zxc", null,
		...
		assertEquals(
				0,
				StringUtil.endsWithOneIgnoreCase("qweZXC", new String[] {
						"Zxc", null, ".", "zxc" }));
		assertEquals(
				-1,
				StringUtil.endsWithOneIgnoreCase("qweZXC", new String[] { "zx",
						null, ".", "zx" }));
	}
	...
	public void testJoin() {
		...
		assertEquals("13", StringUtil.join("1", null, "3"));
	}
	...
	public void testEscape() {
		...
		assertEquals(-1,
				StringUtil.indexOfUnescapedChar("1\\23244", '2', '\\', 6));
	...
	public void testToCamelCase() {
		assertEquals("oneTwoThree",
				StringUtil.toCamelCasing("one two   three", false, ' '));
		assertEquals("OneTwo.Three",
				StringUtil.toCamelCasing("one two. three", true, ' '));
		assertEquals("OneTwoThree",
				StringUtil.toCamelCasing("One-two-three", true, '-'));

		assertEquals("userName",
				StringUtil.toCamelCasing("user_name", false, '_'));
		assertEquals("UserName",
				StringUtil.toCamelCasing("user_name", true, '_'));
		assertEquals("user", StringUtil.toCamelCasing("user", false, '_'));
		assertEquals("User", StringUtil.toCamelCasing("user", true, '_'));
	}

	@Test
	public void testFromCamelCase() {
		assertEquals("one two three",
				StringUtil.fromCamelCasing("oneTwoThree", ' '));
		assertEquals("one-two-three",
				StringUtil.fromCamelCasing("oneTwoThree", '-'));
		assertEquals("one. two. three",
				StringUtil.fromCamelCasing("one.Two.Three", ' '));

		assertEquals("user_name", StringUtil.fromCamelCasing("userName", '_'));
		assertEquals("user_name", StringUtil.fromCamelCasing("UserName", '_'));
		assertEquals("user_name", StringUtil.fromCamelCasing("USER_NAME", '_'));
		assertEquals("user_name", StringUtil.fromCamelCasing("user_name", '_'));
		assertEquals("user", StringUtil.fromCamelCasing("user", '_'));
		assertEquals("user", StringUtil.fromCamelCasing("User", '_'));
		assertEquals("user", StringUtil.fromCamelCasing("USER", '_'));
		assertEquals("user", StringUtil.fromCamelCasing("_user", '_'));
		assertEquals("user", StringUtil.fromCamelCasing("_User", '_'));
		assertEquals("_user", StringUtil.fromCamelCasing("__user", '_'));
		assertEquals("user__name",
				StringUtil.fromCamelCasing("user__name", '_'));
	}
	...
	// String to = "\\r\\t\\b\\f\\n\\\\\\\"asd\\u0111q\\u0173aa\\u0abc\\u0abc";
	//
	// assertEquals(to, StringEscapeUtil.escapeJava(from));
	// assertEquals(from, StringEscapeUtil.unescapeJava(to));
	// }
	...
	public void testFindCommonPrefix() {
		...
		assertEquals("12",
				StringUtil.findCommonPrefix("123xxx", "125", "12xxxxx"));
	...
	public void testShorten() {
		assertEquals("Long...",
				StringUtil.shorten("Long long sentence", 8, "..."));
		assertEquals("Longl...",
				StringUtil.shorten("Longlong sentence", 8, "..."));
	}
	...
	@Test
	public void testJavaStyleMethodName() {
		assertEquals(StringUtil.getJavaStyleMethodName(null, null), null);
		assertEquals(StringUtil.getJavaStyleMethodName(null, "get"), null);
		assertEquals(StringUtil.getJavaStyleMethodName("name", null), null);
		assertEquals(StringUtil.getJavaStyleMethodName("name", "get"),
				"getName");
		assertEquals(StringUtil.getJavaStyleMethodName("name", "is"), "isName");
		assertEquals(StringUtil.getJavaStyleMethodName("name", "set"),
				"setName");
		assertEquals(StringUtil.getJavaStyleMethodName("Name", "get"),
				"getName");
	}
