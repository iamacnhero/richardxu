...
import com.richardxu.common.lang.format.Printf;
import com.richardxu.common.lang.format.PrintfFormat;
...
public class FormatTest {
	...
	public void testStrings() {
		...
		assertEquals(
				" q w 1 2 3 ",
				Printf.str(" %s %s %s %s %s ", new String[] { "q", "w", "1",
						"2", "3" }));
	...
	public void testBinary() {
		...
		assertEquals("11111111 11111111 11111111 11110011",
				Printf.str("%,b", -13));
		assertEquals(
				"1111111111111111111111111111111111111111111111111111111111110011",
				Printf.str("%b", -13L));
		assertEquals(
				"11111111 11111111 11111111 11111111 11111111 11111111 11111111 11110011",
				Printf.str("%,b", -13L));
	}
